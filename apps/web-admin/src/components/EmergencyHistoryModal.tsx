  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white p-6 space-y-6 my-auto cursor-default"
      >
        ...
        {loading ? (
          <div className="py-12 text-center space-y-3">
            ...
            <p className="text-xs text-slate-500 font-medium">Carregando histórico de ocorrências...</p>
          </div>
        ) : occurrences.length === 0 ? (
          <div className="py-12 px-4 text-center space-y-3 bg-slate-50 dark:bg-slate-800/40 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700">
            <div className="w-12 h-12 rounded-2xl bg-emerald-100 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mx-auto text-xl font-bold">
              📜
            </div>
            <div className="space-y-1 max-w-sm mx-auto">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                Você não possui chamados de socorro registrados, acionados ou finalizados recentemente em seu histórico.
              </p>
            </div>
          </div>
        ) : (
