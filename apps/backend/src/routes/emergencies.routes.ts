...
// GET /api/v1/emergencies/active (Retorna ocorrência ativa do campus/usuário)
emergenciesRouter.get('/active', authMiddleware, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const user = req.user
